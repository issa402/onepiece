...
async function setupDatabase() {
    try {
        ...
        console.log('📊 YOUR onepiece_market database is ready for Django Enterprise!');
        console.log('');
